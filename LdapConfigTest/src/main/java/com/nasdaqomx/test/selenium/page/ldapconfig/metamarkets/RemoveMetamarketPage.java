...
public class RemoveMetamarketPage extends MetamarketBasePage {

	private static final String URL = "removeMetaMarket.view";
	...
	public RemoveMetamarketPage(TestManager testManager) {
		super(testManager);
	...
	public ListMetamarketsPage submitRemove() {
