...
public class AddManagerTest extends AbstractTest {
	...
	public void testAddSameManager() {
		// get the total number of managers in the list before add
		int totalManager = listManagersPage.getTotalNumber();
		// get data
		setData();
		// get all details of the existing manager
		EditManagerDetailsPage editPage = listManagersPage
				.toEditManager(userId);
		String exsitingSurname = editPage.getSurname();
		String exsitingFullName = editPage.getFullName();
		String exsitingEmail = editPage.getEmail();
		String exsitingPhone = editPage.getPhone();
		String exsitingMobile = editPage.getMobile();
		String exsitingUserTimezone = editPage.getUserTimezone();
		String exsitingUserLanguage = editPage.getUserLanguage();
		String exsitingComments = editPage.getComments();

		// go to add manager page
		AddManagerPage addManagerPage = editPage.toManagers().toAddManager();
		// fill in the page
		addManagerPage.typeUserId(userId);
		addManagerPage.typeSurname(surname);
		addManagerPage.typeFullName(fullName);
		...
		editPage = listManagersPage.toEditManager(userId);
		verifyEquals(exsitingSurname, editPage.getSurname());
		verifyEquals(exsitingFullName, editPage.getFullName());
		verifyEquals(exsitingEmail, editPage.getEmail());
		verifyEquals(exsitingPhone, editPage.getPhone());
		verifyEquals(exsitingMobile, editPage.getMobile());
		verifyEquals(exsitingUserTimezone, editPage.getUserTimezone());
		verifyEquals(exsitingUserLanguage, editPage.getUserLanguage());
		verifyEquals(exsitingComments, editPage.getComments());
	}
