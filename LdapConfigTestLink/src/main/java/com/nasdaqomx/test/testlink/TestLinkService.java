...
public class TestLinkService {
	...
	public AutomationTestCase getTestCase(Integer testCaseId) {
		if (debug) {
			AutomationTestCase t = new AutomationTestCase(new TestCase());
			t.setId(1);
			t.setExternalId("LDAPC-12345");
			t.setSummary("Login with wrong username and right password");
			t.setAutomationKey("ldapconfig.loginout.LoginTest.testLoginFail");
			t.setInputData("username=autoTest1234 password=Test1234 usernameAfter=autoTest passwordAfter=Test1234");
			t.setOutputData("msg=Username or password invalid please try again");
			return t;
		}
